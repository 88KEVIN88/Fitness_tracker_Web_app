    ...
    <?php foreach ($schede as $scheda): ?>
        <li class="list-group-item">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="modify_scheda.php?id=<?= htmlspecialchars($scheda['id_scheda']) ?>" class="btn btn-secondary">Modifica</a>
                    <a href="../handlers/deleteSchedaHandler.php?id=<?= htmlspecialchars($scheda['id_scheda']) ?>" class="btn btn-danger" onclick="return confirm('Sei sicuro di voler eliminare questa scheda?')">Elimina</a>
                </div>
            </div>
